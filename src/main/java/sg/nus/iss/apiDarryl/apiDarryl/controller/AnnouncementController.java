...
import sg.nus.iss.apiDarryl.apiDarryl.service.AnnouncementService;

@Tag(description = "Announcement resources that provides access to available announcement data", name = "Announcement Resource")
@RestController
@RequestMapping("/api")
public class AnnouncementController {
    ...
    @Operation(summary = "Create new annoumcenemt", description = "create a new announcement")
    @PostMapping("/announcements")
    public ResponseEntity<Announcement> saveAnnnuncement(@RequestBody Announcement announcement){
        try{
    ...
    public ResponseEntity<Long> deletCategory(@PathVariable("id") Long id){
        try{
